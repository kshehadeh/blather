...
9. Select **Run health checks** and confirm that no Bluesky error appears.
...
Repeat **Add Account…** with a separate app password for each additional Bluesky identity.
